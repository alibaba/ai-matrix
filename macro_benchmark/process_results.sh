...
if [ -f DSSD/results/results_train.csv ]; then
	...
	echo "DSSD/results/results_train.csv does not exit, check if test is ran successfully"
fi

if [ -f DSSD/results/results_infer.csv ]; then
	cp DSSD/results/results_infer.csv results/results_dssd_infer.csv
else
	echo "DSSD/results/results_infer.csv does not exit, check if test is ran successfully"
fi
