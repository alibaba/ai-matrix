...
def add_parser_arguments(parser):
    ...
    parser.add_argument('--num_accelerators', default=1, type=int, metavar='N',
    ...
    parser.add_argument('--training_only', action='store_true', help='do not evaluate')
...
def main(args):
    ...
    print("args.data_backend: ", args.data_backend)
    ...
    end_time = time.time()
    num_iters = args.prof if args.prof > 0 else train_loader_len
    total_images = args.epochs * num_iters * args.batch_size * args.num_accelerators
    exp_duration = time.time() - exp_start_time
    if not torch.distributed.is_initialized() or torch.distributed.get_rank() == 0:
        logger.end()
    approximate_time = end_time - start_time
    print("Total number of images: ", total_images)
    print("Approximate acceleration time: ", approximate_time)
    #print("Total time: ", exp_duration)
    print("Approximate accelerator performance in images/s: ", total_images/approximate_time)
    #print("System performance in images/s: ", total_images/exp_duration)
