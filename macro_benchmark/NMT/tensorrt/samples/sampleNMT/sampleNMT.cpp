...
nmtSample::DataWriter::ptr getDataWriter()
{
    ...
    else if (gDataWriterStr == "text")
    {
        ...
        assert(textOutput->good() && "Please contact system administrator if you have no permission to write the file translation_output.txt");
    ...
    nmtSample::Alignment::ptr alignment)
{
    ...
    encoderBuilder->setInt8Mode(gInt8);
    ...
    samplesCommon::setDummyInt8Scales(encoderBuilder, encoderNetwork);
    ...
    nmtSample::Likelihood::ptr likelihood)
{
    ...
    generatorBuilder->setInt8Mode(gInt8);
    ...
    samplesCommon::setDummyInt8Scales(generatorBuilder, generatorNetwork);
...
nvinfer1::ICudaEngine* getGeneratorShuffleEngine(const std::vector<nvinfer1::Dims>& decoderStateSizes, int attentionSize)
{
    ...
    shuffleBuilder->setInt8Mode(gInt8);
    ...
    samplesCommon::setDummyInt8Scales(shuffleBuilder, shuffleNetwork);
