...
def process_infer():
    ...
    table0.append(['batch 4','batch 8','batch 16'])
    ...
    table1.append(['batch 4','batch 8','batch 16'])
    ...
    for b in bs:
        ...
        with open(fname, "r") as ins:
            for line in ins:
                if (len(line.split()) > 2):
                    if ( line.split()[0]== 'Approximate' and line.split()[1]== 'inference' and line.split()[2]== 'accelerator' and is_number(line.split()[-1])):
                        val = line.split()[-1]
                        val = float(val)
...
def process_train():
    ...
    for b in bs:
        ...
        with open(fname, "r") as ins:
            for line in ins:
                if (len(line.split()) > 2):
                    if ( line.split()[0]== 'Approximate' and line.split()[1]== 'training' and line.split()[2]== 'accelerator' and is_number(line.split()[-1])):
                        val = line.split()[-1]
                        val = float(val)
                        row_table1.append(val)
                    if ( line.split()[0]== 'System' and line.split()[1]== 'performance' and is_number(line.split()[-1])):
