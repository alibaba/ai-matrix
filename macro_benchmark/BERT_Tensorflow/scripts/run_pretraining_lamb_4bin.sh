...
RESULTS_DIR=${RESULTS_DIR:-results/32}
...
input_files="$DATA_DIR/create_maxlen128_dupe2_MLM015_NSP_wikiSentSeg/wiki_dupe2_lowercase_4sec/32"
checkpoint="None"
...
input_files="$DATA_DIR/create_maxlen128_dupe2_MLM015_NSP_wikiSentSeg/wiki_dupe2_lowercase_4sec/64"
checkpoint=`ls results/32/phase_1/model.ckpt-*.index | sort -V | tail -1`
...
input_files="$DATA_DIR/create_maxlen128_dupe2_MLM015_NSP_wikiSentSeg/wiki_dupe2_lowercase_4sec/96"
checkpoint=`ls results/64/phase_1/model.ckpt-*.index | sort -V | tail -1`
checkpoint=${checkpoint%'.index'}
seq_len=96
...
input_files="$DATA_DIR/create_maxlen128_dupe2_MLM015_NSP_wikiSentSeg/wiki_dupe2_lowercase_4sec/128"
checkpoint=`ls results/96/phase_1/model.ckpt-*.index | sort -V | tail -1`
checkpoint=${checkpoint%'.index'}
seq_len=128
