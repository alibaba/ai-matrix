...
def process_infer_trt(pc):
    ...
    table0.append(['model','batch 2','batch 4','batch 6'])
    ...
    table1.append(['model','batch 2','batch 4','batch 6'])
        ...
        for b in bs:
            ...
            with open(fname, "r") as ins:
                for line in ins:
                    if not line.strip():
                        continue             
                    if (line.split(' ')[0]== 'Performance' and  line.split(' ')[-2]=='images/sec:' and  is_number(line.split(' ')[-1])):
                        #print('=======', line)
                        val = line.split()[-1]
                        val = float(val)
