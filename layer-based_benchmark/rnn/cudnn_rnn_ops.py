...
class RnnOps:
    ...
    def lstm(self, inst, log):
        ...
        outputs, last_states = cell(inputs, training=False)
    ...
    def gru(self, inst, log):
        ...
        #define cell
        num_layers = 1
        cell = tf.contrib.cudnn_rnn.CudnnGRU(num_layers, num_units)
        outputs, last_states = cell(inputs, training=False)
    ...
    def rnn(self, inst, log):
        ...
        #define cell
        num_layers = 1
        cell = tf.contrib.cudnn_rnn.CudnnRNNRelu(num_layers, num_units)
        outputs, last_states = cell(inputs, training=False)
...
class RnnOpTest:
    def __init__(self, op_name, times, interval, min_bs, max_bs, stride_bs, min_sl, max_sl, stride_sl, min_units, max_units, stride_units):
        ...
        self.log = open('log/cudnn_'+op_name+'.log', 'w')
